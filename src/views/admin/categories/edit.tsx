...
import { useCategoryById } from "../../../hooks/admin/category/useCategoryEdit";
...
const CategoryEdit: React.FC = () => {
    // Change title page
    document.title = "Edit Category - GIS Desa Santri";
    ...
    // Initialize useCategoryById hook
    ...
    // Initialize useCategoryUpdateHook
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        mutate(
            ...
            {
                onSuccess: () => {
                    // Redirect to page category after success
